/* Generated from URL http://ddragon.leagueoflegends.com/cdn/9.22.1/data/en_US/item.json */
...
export enum GameItem {
    ...
    ANCIENT_COIN = 3301, // Ancient Coin
    ARCANE_SWEEPER_3187 = 3187, // Arcane Sweeper
    ARCANE_SWEEPER_3348 = 3348, // Arcane Sweeper
    ...
    BRAWLERS_GLOVES = 1051, // Brawler's Gloves
    ...
    ELIXIR_OF_SKILL = 2011, // Elixir Of Skill
    ...
    GOLDEN_TRANSCENDENCE = 3460, // Golden Transcendence
    GOLDEN_TRANSCENDENCE_DISABLED = 3461, // Golden Transcendence (Disabled)
    ...
    HEART_OF_TARGON = 4302, // Heart of Targon
    ...
    LIGHTBRINGER = 3185, // Lightbringer
    LOCKET_OF_THE_IRON_SOLARI = 3190, // Locket of the Iron Solari
    LONG_SWORD = 1036, // Long Sword
    LOOTED_BISCUIT_OF_REJUVENATION = 2012, // Looted Biscuit of Rejuvenation
    LOOTED_ORACLES_EXTRACT = 2013, // Looted Oracle's Extract
    ...
    NEXUS_SIEGE_SIEGE_WEAPON_SLOT = 3637, // Nexus Siege: Siege Weapon Slot
    NINJA_TABI = 3047, // Ninja Tabi
    NOMADS_MEDALLION = 3096, // Nomad's Medallion
    ...
    PEERING_FARSIGHT_WARD = 2057, // Peering Farsight Ward
    PERFECT_HEX_CORE = 3198, // Perfect Hex Core
    PHAGE = 3044, // Phage
    PHANTOM_DANCER = 3046, // Phantom Dancer
    PHILOSOPHERS_MEDALLION = 4301, // Philosopher's Medallion
    PICKAXE = 1037, // Pickaxe
    PILFERED_HEALTH_POTION = 2061, // Pilfered Health Potion
    PILFERED_POTION_OF_ROUGE = 2062, // Pilfered Potion of Rouge
    PILFERED_STEALTH_WARD = 2056, // Pilfered Stealth Ward
    PORO_SNAX = 2052, // Poro-Snax
    PORT_PAD = 3635, // Port Pad
    ...
    RELIC_SHIELD = 3302, // Relic Shield
    REMNANT_OF_THE_ASCENDED = 3069, // Remnant of the Ascended
    REMNANT_OF_THE_ASPECT = 3401, // Remnant of the Aspect
    REMNANT_OF_THE_WATCHERS = 3092, // Remnant of the Watchers
    ...
    SEER_STONE_TRINKET_3462 = 3462, // Seer Stone (Trinket)
    SEER_STONE_TRINKET_3645 = 3645, // Seer Stone (Trinket)
    SERAPHS_EMBRACE_3040 = 3040, // Seraph's Embrace
    SERAPHS_EMBRACE_3048 = 3048, // Seraph's Embrace
    SERRATED_DIRK = 3134, // Serrated Dirk
    SHEEN = 3057, // Sheen
    SHIELD_TOTEM = 3647, // Shield Totem
    SHURELYAS_REVERIE = 2065, // Shurelya's Reverie
    SIEGE_BALLISTA = 3631, // Siege Ballista
    SIEGE_REFUND = 3642, // Siege Refund
    SIEGE_SIGHT_WARDER = 3649, // Siege Sight Warder
    SIEGE_TELEPORT_3630 = 3630, // Siege Teleport
    SIEGE_TELEPORT_3633 = 3633, // Siege Teleport
    SIEGE_TELEPORT_INACTIVE = 3648, // Siege Teleport (Inactive)
    ...
    SLY_SACK_OF_GOLD = 2319, // Sly Sack of Gold
    SORCERERS_SHOES = 3020, // Sorcerer's Shoes
    SOUL_ANCHOR_TRINKET = 3345, // Soul Anchor (Trinket)
    SPACE_BILGEWATER_CUTLASS = 3162, // Space Bilgewater Cutlass
    SPACE_BLADE_OF_THE_RUINED_KING = 3149, // Space Blade of the Ruined King
    SPACE_BLOODTHIRSTER = 3080, // Space Bloodthirster
    SPACE_BOOTS_OF_LUCIDITY = 3173, // Space Boots of Lucidity
    SPACE_DEATHS_DANCE = 3813, // Space Death's Dance
    SPACE_HEXTECH_GUNBLADE = 3148, // Space Hextech Gunblade
    SPACE_KNIGHTS_VOW = 3118, // Space Knight's Vow
    SPACE_MAW_OF_MALMORTIUS = 3163, // Space Maw of Malmortius
    SPACE_MERCURIAL_SCIMITAR = 3231, // Space Mercurial Scimitar
    SPACE_RAVENOUS_HYDRA = 3230, // Space Ravenous Hydra
    SPACE_VAMPIRIC_SCEPTER = 1059, // Space Vampiric Scepter
    ...
    SPELLTHIEFS_EDGE = 3303, // Spellthief's Edge
    SPIRIT_VISAGE = 3065, // Spirit Visage
    STALKERS_BLADE = 3706, // Stalker's Blade
    STAT_STICK_OF_STOICISM = 4403, // Stat-Stick of Stoicism
    ...
    TARGONS_BRACE = 3097, // Targon's Brace
    ...
    TOWER_BEAM_OF_RUINATION = 3634, // Tower: Beam of Ruination
    TOWER_STORM_BULWARK = 3636, // Tower: Storm Bulwark
    TRAVEL_SIZE_ELIXIR_OF_IRON = 2058, // Travel Size Elixir of Iron
    TRAVEL_SIZE_ELIXIR_OF_SORCERY = 2059, // Travel Size Elixir of Sorcery
    TRAVEL_SIZE_ELIXIR_OF_WRATH = 2060, // Travel Size Elixir of Wrath
    ...
    VANGUARD_BANNER = 3641, // Vanguard Banner
    ...
    WICKED_HATCHET = 3122, // Wicked Hatchet
